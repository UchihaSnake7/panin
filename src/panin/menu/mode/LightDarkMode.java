...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Luminoso", new FlatSVGIcon("panin/menu/mode/light.svg"));
        buttonDark = new JButton("Oscuro", new FlatSVGIcon("panin/menu/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("panin/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("panin/menu/mode/light.svg"));
        }
    }
